...
class ResetPasswordAPITests(EventTestMixin, CacheIsolationTestCase):
    ...
    def test_forgot_password_sets_primary_email_on_account_recovery_query_param(self):
        """
    ...
    def test_forgot_password_email_send_email_on_account_recovery_query_param(self):
        """
